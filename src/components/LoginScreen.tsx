...
import { Eye, EyeOff, Lock, User as UserIcon, ArrowRight, ShieldCheck, KeyRound } from 'lucide-react';
...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#401669] via-[#351059] to-[#250047] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      {/* Centered Login Card matching the mockup image */}
      <div className="bg-white rounded-[2rem] p-8 sm:p-11 w-full max-w-md shadow-2xl border border-white/20 flex flex-col items-center relative z-10 animate-fadeIn">
        
        {/* METARH Logo */}
        <div className="mb-6 flex justify-center">
          <svg id="Camada_1" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1304.54 394.27" className="h-10 w-auto fill-[#401669]">
        ...
        {/* Error Alert */}
        {errorMsg && (
          <div className="w-full bg-rose-50 border border-rose-200 text-rose-700 text-xs p-3 rounded-xl mb-5 text-center font-medium animate-fadeIn">
            {errorMsg}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 text-xs bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#9c3aff] focus:bg-white text-slate-800 font-medium transition-all"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-4 pr-11 py-3 text-xs bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#9c3aff] focus:bg-white text-slate-800 font-medium transition-all"
              />
              <button
                type="button"
          ...
          <button
            ...
            className="w-full py-3.5 px-6 rounded-2xl text-white font-bold text-xs bg-gradient-to-r from-[#9732f7] to-[#b848ff] hover:from-[#8922eb] hover:to-[#a936ff] transition-all cursor-pointer shadow-md hover:shadow-lg flex items-center justify-center gap-2 mt-6 active:scale-[0.99] disabled:opacity-50"
          >
