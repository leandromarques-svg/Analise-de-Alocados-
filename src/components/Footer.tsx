  ...
  return (
    <footer className="bg-[#ede4f5] text-slate-700 text-xs border-t border-[#dfd2ee] mt-12 py-10 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Top Header inside Footer with METARH Logo */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-8 border-b border-[#dfd2ee]">
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-500">
          <p>© {new Date().getFullYear()} METARH — Gestão Contínua de Colaboradores. Todos os direitos reservados.</p>
          <p className="flex items-center gap-1 font-medium text-slate-600">
            Desenvolvido para inteligência de Recursos Humanos
          </p>
        </div>
      </div>
    </footer>
